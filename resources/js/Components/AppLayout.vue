...
const items = [
  ...
  { href: '/guides', label: 'Panduan', icon: icons.guides, roles: ['Admin', 'Pembina', 'Pengurus', 'Anggota'] },
  { href: '/medias', label: 'Mars Ambalan', icon: icons.medias, roles: ['Admin', 'Pembina', 'Pengurus', 'Anggota'] },
