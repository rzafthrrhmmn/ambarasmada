      ...
      <div class="mx-auto flex max-w-[1500px] items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
        <div class="flex items-center gap-3">
          ...
          <Link href="/dashboard" class="flex items-center gap-3">
            <span v-if="ambalan?.logo_url" class="flex h-14 w-14 items-center justify-center rounded-xl border-2 border-[#6F9435] bg-[#263D26] overflow-hidden"><img :src="ambalan.logo_url" alt="Logo" class="h-full w-full object-contain" /></span>
            <span v-else class="flex h-14 w-14 items-center justify-center rounded-xl border-2 border-[#6F9435] bg-[#263D26] overflow-hidden"><img :src="'/images/Logo_Ambalan.png'" alt="Logo" class="h-full w-full object-contain" /></span>
            <span>
        ...
        <aside v-if="mobileMenuOpen" class="fixed inset-y-0 left-0 z-50 flex w-72 max-w-[85vw] flex-col border-r-2 border-[#A7B92A]/30 bg-[#263D26] p-4 shadow-2xl lg:hidden">
          <div class="mb-4 flex items-center justify-between">
            <div class="flex items-center gap-3">
              ...
              <span v-else class="flex h-10 w-10 items-center justify-center rounded-xl border-2 border-[#6F9435] bg-[#263D26] overflow-hidden"><img :src="'/images/Logo_Ambalan.png'" alt="Logo" class="h-full w-full object-contain" /></span>
              <div>
                <span class="block text-sm font-bold text-[#EDD330]">{{ ambalan?.nama || 'Pramuka SMAN 2 Maros' }}</span>
...
const items = [
  ...
  { href: '/finance', label: 'Keuangan/Iuran', icon: icons.finance, roles: ['Admin', 'Pembina', 'Pengurus', 'Anggota'] },
...
const visibleNavItems = computed(() => {
  ...
  return items.filter((item) => {
    ...
    if (item.href === '/finance' && role === 'Pengurus') {
