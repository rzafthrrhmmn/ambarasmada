<template>
  <AppLayout>
    ...
    <div class="space-y-4">
      ...
      <SkeletonLoader v-if="!teams" variant="card" :lines="4" />
      <p v-else-if="!teams.length" class="rounded-xl border-2 border-[#6F9435]/30 bg-[#335233] p-10 text-center text-sm text-[#8fa06a]">Belum ada gugus depan.</p>
    </div>
