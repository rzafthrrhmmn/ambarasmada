...
// Nonaktifkan Laravel's built-in error handler yang mengubah E_WARNING ke ErrorException
// karena environment Vercel yang berbeda
$whoops = $app->make(\Illuminate\Contracts\Debug\ExceptionHandler::class);

// 7. Handle request dengan cara yang aman di environment serverless
$response = $app->handleRequest(Request::capture());

// 8. Kirim response secara manual untuk mencegah double-send
if (! headers_sent()) {
    $response->send();
}
